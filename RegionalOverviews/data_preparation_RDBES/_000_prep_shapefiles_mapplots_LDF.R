...
sp1<-rgdal::readOGR(dsn="C:/-=Work=-/RCGs-master/RegionalOverviews/data/shapefiles/FAO_areas", layer="FAO_AREAS_NOCOASTLINE")
...
shapefile(sp2, 'C:/-=Work=-/RCGs-master/RegionalOverviews/data/shapefiles/RCG_LDF_FAOareas.shp', overwrite=TRUE)
...
shapefile(sp2, 'C:/-=Work=-/RCGs-master/RegionalOverviews/data/shapefiles/RCG_LDF_FAOareas34.shp', overwrite=TRUE)
...
# shapefile fao areas
sp2<-list("shp" = shapefiles::read.shp("C:/-=Work=-/RCGs-master/RegionalOverviews/data/shapefiles/RCG_LDF_FAOareas34.shp"),
          "shx" = shapefiles::read.shx("C:/-=Work=-/RCGs-master/RegionalOverviews/data/shapefiles/RCG_LDF_FAOareas34.shx"), 
          "dbf"= shapefiles::read.dbf("C:/-=Work=-/RCGs-master/RegionalOverviews/data/shapefiles/RCG_LDF_FAOareas34.dbf"))
...
sp1<-rgdal::readOGR(dsn="RegionalOverviews/data/shapefiles/FAO_areas", layer="FAO_AREAS_NOCOASTLINE")
...
shapefile(sp2, 'RegionalOverviews/data/shapefiles/RCG_LDF_FAOareasMajor.shp', overwrite=TRUE)
