...
### Landings abroad
```{r riverplot aborad, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6}
...
#   mutate(CLlandingCountry=paste(CLlandingCountry, " ", sep=""))-> df
# 
# result=func_StankeyDiagram(df = df,
