...
cl_catch <- merge(cl, catch_group, by = "ISSCAAP")

barplot(data = cl_catch, 
      x = "RCM_NSEA_categ",
      y = "CLscientificWeight_1000ton",
      title = "Landings (1000 t) by Catch Group",
      ylab = "Proportion of Landings (1000 t)")
...
barplot(data = cl, 
      ...
      y = "CLscientificWeight_1000ton",
      group = "CLlandingCountry",
      titel = "Landings (1000 t) by Vessel Length Category and Country",
      ylab = "Proportion of Landings (1000 t)",
      asPct = T)
...
barplot(data = cl, 
      ...
      y = "CLscientificWeight_1000ton",
      group = "CLlandingCountry",
      titel = "Landings (1000 t) by Area and Country",
      ylab = "Proportion of Landings (1000 t)",
      asPct = T)
...
barplot(data = cl, 
      ...
      y = "CLscientificWeight_1000ton",
      group = "CLarea",
      titel = "Landings (1000 t) by Country and Area",
      ylab = "Proportion of Landings (1000 t)",
      asPct = T)
...
barplot(data = cl_harbour, 
      x = "CLlandingLocation",
      y = "CLscientificWeight_1000ton",
      titel = "Landings (1000 t) by Harbours",
      ylab = "Sum of Landings (1000 t)")
```
...
barplot(data = cl_harbour_fc_top, 
        x = "CLlandingLocation",
        y = "CLscientificWeight_1000ton_total",
        titel = "Landings (1000 t) by Harbour and Flag Country",
...
barplot(data = cl_spf, 
      x = "CLlandingCountry",
      y = "CLscientificWeight_1000ton",
      titel = "Landings (1000 t) by Country",
      ylab = "Sum of Landings (1000 t)")
```
