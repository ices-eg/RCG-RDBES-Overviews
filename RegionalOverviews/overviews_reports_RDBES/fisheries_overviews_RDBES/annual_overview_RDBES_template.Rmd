...
params:
  ...
  region: 'BA'
  year: 2021
  logo_path: "D:/RCG-RDBES-Overviews/RegionalOverviews/data/logo/logo RCG BALTIC.PNG"
  data_dir: 'D:/RCG-RDBES-Overviews/RegionalOverviews/data_RDBES/002_prepared/20240129/RCG_BA'
  data_dir_fleet: 'D:/RCG-RDBES-Overviews/RegionalOverviews/data/fleet_reg/output/2021'
...
source("D:/RCG-RDBES-Overviews/RegionalOverviews/funs_RDBES/choroplethMap_func2.R", local = knitr::knit_global())
source("D:/RCG-RDBES-Overviews/RegionalOverviews/funs_RDBES/pointsMap_func2.R", local = knitr::knit_global())
#load barplot fuction
source("D:/RCG-RDBES-Overviews/RegionalOverviews/funs_RDBES/func_barplot.R", local = knitr::knit_global())
...
source('D:/RCG-RDBES-Overviews/RegionalOverviews/overviews_reports_RDBES/fisheries_overviews_RDBES/scripts/loadData.R', local = knitr::knit_global())
...
### Landings by catch species group {.tabset}
#### catch species group
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6}
...
barplot(data = cl, 
      x = "CatchGroup",
      y = "CLscientificWeight_1000ton",
      title = "Landings (1000 t) by Catch Species Group",
      ylab = "Proportion of Landings (1000 t)")
```

#### catch species group and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6}
...
barplot(data = cl, 
      ...
      y = "CLscientificWeight_1000ton",
      group = "CLlandingCountry",
      title = "Landings (1000 t) by Catch Species Group and Country",
      ylab = "Proportion of Landings (1000 t)",
      asPct = T)
...
## Appendix B. Catch species groups
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6}
# data prep
cl%>%
