...
# Introduction
The RDBES data model is an evolution of the work already done in defining and using the previous Regional Database (RDB) and the COST data models and functions.
...
These data formats are collecting aggregated data from national commercial fisheries. It allows for both official and scientific estimates of landings and effort in order to have transparency in what is scientific estimates. The scientific estimates will be used for scientific work, e.g, stock assessment, and the official will be used for reference to compare with other data sources, and to illustrate what are scientific estimates.
## Reading the graphs
### Barplots
put some text here
...
paste("River plot of CLscientificWeight_ton between CLvesselFlagCountry (left) and Harbour (right). Width of line is proportional to landings", sep="")  
    
cl %>%
  group_by(CLyear, HarbourCountry2, CLvesselFlagCountry) %>%
...
paste("River plot of CLscientificWeight_ton of small pelagic between CLvesselFlagCountry (left) and Harbour (right). Width of line is proportional to landings", sep="")  
...
paste("River plot of CLscientificWeight_ton of demersal between CLvesselFlagCountry (left) and Harbour (right). Width of line is proportional to landings", sep="")  
...
paste("River plot of CLscientificWeight_ton of flatfish between CLvesselFlagCountry (left) and Harbour (right). Width of line is proportional to landings", sep="")  
