...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 27**: Spatial distribution of the small pelagics landings by area and country.'}
cl %>%
  filter(CatchGroup == 'small pelagic') %>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 27**: Spatial distribution of the demersal landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 27**: Spatial distribution of the demersal landings by area and flag country.'}
cl %>%
  filter(CatchGroup == 'demersal') %>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 27**: Spatial distribution of the flatfish landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 27**: Spatial distribution of the flatfish landings by area and flag country.'}
cl %>%
  filter(CatchGroup == 'flatfish') %>%
  group_by(CLvesselFlagCountry, AreaMap) %>%
  summarise(CLscientificWeight_ton = sum(CLscientificWeight_ton)) %>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 27**: Spatial distribution of the crustaceans landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 27**: Spatial distribution of the crustaceans landings by area and flag country.'}
cl %>%
  filter(CatchGroup == 'crustaceans') %>%
  group_by(CLvesselFlagCountry, AreaMap) %>%
  summarise(CLscientificWeight_ton = sum(CLscientificWeight_ton)) %>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 110**: Distribution of the number of trips performed by country vessels with LOA below 10m, from the main harbours (top 20).'}
sub_ce_top %>%  mutate(
         analysis_type = 'sum',
         type_of_threshold = 'none',
         value_of_threshold = NA
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 110**: Distribution of the number of trips performed by country vessels with LOA 10m and above, from the main harbours (top 20).'}
sub_ce_top %>%  mutate(
         analysis_type = 'sum',
         type_of_threshold = 'none',
         value_of_threshold = NA
