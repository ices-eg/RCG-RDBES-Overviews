...
### Maps
The maps are based on complete and available data from the RDBES. The subtitles of the header refer to the sub-selection that is displayed (e.g. “all Data”, “pelagics”, etc.).  If the data cannot be shown on a map (e.g. due to missing information on the area or harbour code), the missing values are given in the figure text below. 
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 27**: Spatial distribution of the small pelagics landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
FAOshp2 = FAOshp %>% rename("Area" = "AreaMap") # a little bit of mess, tidy it up some day
# for choropleth -> name of column with area in shp can not be the same as name of column with area in the df
# for scatterpie -> name of column with area in shp has to be the same as name of column with area in the df
# quick fix - two copies of the same shp
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 28**: Spatial distribution of the small pelagics landings by area and country.'}
cl %>%
  filter(CatchGroup == 'small pelagic') %>%
  group_by(CLyear, CLvesselFlagCountry, AreaMap) %>%
  summarise(CLscientificWeight_ton = sum(CLscientificWeight_ton)) %>%
  mutate(pr= CLscientificWeight_ton/sum(CLscientificWeight_ton, na.rm = TRUE)*100,
         func = 'sum',
         type_of_threshold = 'none',
...
#### Metier lvl5
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap = '**Figure 29**: Small pelagics landings by metier level 5 (top 20).'}
#data prep
sub_cl_top <- cl%>%
  filter(CatchGroup == 'small pelagic')%>%
  mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl5 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 30**: Proportion of countries landings of small pelagics by metier level 5 (top 20).'}
#data prep
sub_cl_2 <- cl%>%
  filter(CatchGroup == 'small pelagic') %>%
    mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl6
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 31**: Small pelagics landings by metier level 6 (top 20).'}
sub_cl_top <- cl%>%
  filter(CatchGroup == 'small pelagic')%>%
  group_by(CLyear, CLmetier6) %>%
  summarise(CLscientificWeight_1000ton = sum(CLscientificWeight_1000ton)) %>%
...
#### Metier lvl6 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 32**: Proportion of countries landings of small pelagics by metier level 6 (top 20).'}
sub_cl_2<- cl%>%
  filter(CatchGroup == 'small pelagic') %>%
  group_by(CLyear, CLmetier6, CLvesselFlagCountry) %>%
  summarise(CLscientificWeight_1000ton_total = sum(CLscientificWeight_1000ton))
...
#### Harbour
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 33**: Small pelagics landings in the main harbours (top 20).'}
sub_cl_top  <- cl %>%
  filter(CatchGroup == 'small pelagic') %>%
  group_by(CLyear, CLlandingLocation) %>%
  summarise(CLscientificWeight_1000ton = sum(CLscientificWeight_1000ton)) %>%
...
#### Harbour and flag country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 34**: Proportion of small pelagics landings by flag country and harbour.'}
sub_cl_2<- cl%>%
  filter(CatchGroup == 'small pelagic')%>%
  group_by(CLyear, CLlandingLocation, CLvesselFlagCountry) %>%
  summarise(CLscientificWeight_1000ton_total = sum(CLscientificWeight_1000ton))
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 35**: Map with the landing weight of small pelagics by main harbours (top 20).'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 37**: Spatial distribution of the small pelagics landings by statistical rectangle.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 38**: Landings of demersal species by country.'}
...
#### Species
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 39**: Landings of the main landed species (top 20) from the demersal species catch group.'}
...
#### Species and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 40**: Proportion of countries with demersal species landings by species (top 20).'}
#data prep
sub_cl_2 <- cl%>%
  filter(CatchGroup == 'demersal') %>%
  group_by(CLyear, SpeciesLaName, CLvesselFlagCountry) %>%
...
#### fleet
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 41**: Landings of demersal species by the combined country*vessel fleet segment (top 20).'}
...
#### Country and fleet
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 42**: Proportion of demersal species landings of the countries by vessel fleet segment.'}
...
#### Fleet and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 43**: Proportion of the vessel fleet segments with landings of demersal species, by country.'}
...
#### Area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 44**: Landings distribution of demersal species, by area.'}
barplot(data = cl[CatchGroup=='demersal',], 
      x = "CLarea",
      y = "CLscientificWeight_1000ton",
      title = "Landings (1000 t) by Area",
...
#### Area and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 45**: Proportion of countries landings of demersal species by area.'}
barplot(data = cl[CatchGroup=='demersal',],
      x = "CLarea",
      y = "CLscientificWeight_1000ton",
      group = "CLvesselFlagCountry",
...
#### Country and area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 46**: Proportion of demersal species landings per area, by country.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 47**: Spatial distribution of the demersal landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 48**: Spatial distribution of the demersal landings by area and flag country.'}
cl %>%
  filter(CatchGroup == 'demersal') %>%
  group_by(CLvesselFlagCountry, AreaMap) %>%
  summarise(CLscientificWeight_ton = sum(CLscientificWeight_ton)) %>%
  mutate(pr= CLscientificWeight_ton/sum(CLscientificWeight_ton, na.rm = TRUE)*100,
         func = 'sum',
         type_of_threshold = 'none',
...
#### Metier lvl5
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 49**: Demersal species landings by metier level 5 (top 20).'}
#data prep
sub_cl_top <- cl%>%
  filter(CatchGroup == 'demersal')%>%
  mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl5 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 50**: Proportion of countries landings of demersal species by metier level 5 (top 20).'}
#data prep
sub_cl_2 <- cl%>%
  filter(CatchGroup == 'demersal') %>%
    mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl6
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 51**: Demersal species landings by metier level 6 (top 20).'}
...
#### Metier lvl6 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 52**: Proportion of countries landings of demersal species by metier level 6 (top 20).'}
...
#### Harbour
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 53**: Demersal species landings in the main harbours (top 20).'}
sub_cl_top  <- cl %>%
  filter(CatchGroup == 'demersal') %>%
  group_by(CLyear, CLlandingLocation) %>%
  summarise(CLscientificWeight_1000ton = sum(CLscientificWeight_1000ton)) %>%
...
#### Harbour and flag country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 54**: Proportion of demersal species landings by flag country and harbour.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 55**: Map with the landing weight of demersal species by main harbours (top 20).'}
...
```{r riverplot aborad demersal, echo = FALSE, warning = FALSE, message = FALSE,results = "asis", dpi=100, fig.width=9,fig.height=9, fig.cap = '**Figure 56**: River plot of demersal species landings between vessel Flag Country (left), Harbour Country (center) and landing Country (right). Width of each line is proportional to landings proportion. Harbour Country is the country code obtained from the CLlandingLocation. '}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 57**: Spatial distribution of the demersal species landings by statistical rectangle.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 58**: Landings of flatfish species by country.'}
...
#### Species
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 59**:  Landings of the main landed species (top 20) from the flatfish species catch group.'}
...
#### Species and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 60**:  Proportion of countries with flatfish species landings by species (top 20).'}
...
#### Fleet
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 61**:  Landings of flatfish species by the combined country*vessel fleet segment (top 20).'}
...
#### Country and fleet
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 62**:  Proportion of flatfish species landings of the countries by vessel fleet segment.'}
...
#### Fleet and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 63**:  Proportion of flatfish species landings of the countries by vessel fleet segment.'}
...
#### Area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 64**:  Landings distribution of flatfish species, by area.'}
barplot(data = cl[CatchGroup=='flatfish',], 
      x = "CLarea",
      y = "CLscientificWeight_1000ton",
      ylab = "Landings (1000 t)")
...
#### Area and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 65**:  Proportion of countries landings of flatfish species by area.'}
barplot(data = cl[CatchGroup=='flatfish',],
      x = "CLarea",
      y = "CLscientificWeight_1000ton",
      group = "CLvesselFlagCountry",
...
#### Country and area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 66**:  Proportion of flatfish species landings per area, by country.'}
barplot(data = cl[CatchGroup=='flatfish',],
      x = "CLvesselFlagCountry",
      y = "CLscientificWeight_1000ton",
      group = "CLarea",
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 67**: Spatial distribution of the flatfish landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 68**: Spatial distribution of the flatfish landings by area and flag country.'}
cl %>%
  filter(CatchGroup == 'flatfish') %>%
  group_by(CLvesselFlagCountry, AreaMap) %>%
  summarise(CLscientificWeight_ton = sum(CLscientificWeight_ton)) %>%
...
#### Metier lvl5
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap = '**Figure 69**:  Flatfish species landings by metier level 5 (top 20).'}
#data prep
sub_cl_top <- cl%>%
  filter(CatchGroup == 'flatfish')%>%
  mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl5 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap = '**Figure 70**:  Proportion of countries landings of flatfish species by metier level 5 (top 20).'}
#data prep
sub_cl_2 <- cl%>%
  filter(CatchGroup == 'flatfish') %>%
    mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl6
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 71**:  Flatfish species landings by metier level 6 (top 20).'}
sub_cl_top <- cl%>%
  filter(CatchGroup == 'flatfish')%>%
  group_by(CLyear, CLmetier6) %>%
  summarise(CLscientificWeight_1000ton = sum(CLscientificWeight_1000ton)) %>%
...
#### Metier lvl6 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 72**:  Proportion of countries landings of flatfish species by metier level 6 (top 20).'}
...
#### Harbour
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 73**:  Flatfish species landings in the main harbours (top 20).'}
...
#### Harbour and flag country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 74**:  Proportion of flatfish species landings by flag country and harbour.'}
sub_cl_2<- cl%>%
  filter(CatchGroup == 'flatfish')%>%
  group_by(CLyear, CLlandingLocation, CLvesselFlagCountry) %>%
  summarise(CLscientificWeight_1000ton_total = sum(CLscientificWeight_1000ton))
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 75**: Map with the landing weight of flatfish species by main harbours (top 20).'}
...
```{r riverplot aborad flatfish, echo = FALSE, warning = FALSE, message = FALSE,results = "asis", dpi=100, fig.width=9,fig.height=9, fig.cap = '**Figure 76**: River plot of flatfish species landings between vessel Flag Country (left), Harbour Country (center) and landing Country (right). Width of each line is proportional to landings proportion. Harbour Country is the country code obtained from the CLlandingLocation.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 77**: Spatial distribution of the flatfish landings by statistical rectangle.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 78**: Landings of crustacean species by country.'}
...
#### Species
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 79**:  Landings of the main landed species (top 20) from the crustacean species catch group.'}
...
#### Species and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 80**:  Proportion of countries with crustacean species landings by species (top 20).'}
...
#### Fleet
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 81**:  Landings of crustacean species by the combined country*vessel fleet segment (top 20).'}
...
#### Country and fleet
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 82**:  Proportion of crustacean species landings of the countries by vessel fleet segment.'}
...
#### Fleet and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 83**:  Proportion of crustacean species landings of the countries by vessel fleet segment.'}
...
#### Area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 84**:  Landings distribution of crustacean species, by area.'}
barplot(data = cl[CatchGroup=='crustaceans',], 
      x = "CLarea",
      y = "CLscientificWeight_1000ton",
      ylab = "Landings (1000 t)")
...
#### Area and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 85**:  Proportion of countries landings of crustacean species by area.'}
barplot(data = cl[CatchGroup=='crustaceans',],
      x = "CLarea",
      y = "CLscientificWeight_1000ton",
      group = "CLvesselFlagCountry",
...
#### Country and area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 86**:  Proportion of crustacean species landings per area, by country.'}
barplot(data = cl[CatchGroup=='crustaceans',],
      x = "CLvesselFlagCountry",
      y = "CLscientificWeight_1000ton",
      group = "CLarea",
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 87**: Spatial distribution of the crustaceans landings by area.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
```{r echo=FALSE, fig.height=10, fig.width=18, message=FALSE, warning=FALSE, dpi=100, results="asis", cache=FALSE, fig.cap = '**Figure 88**: Spatial distribution of the crustaceans landings by area and flag country.'}
cl %>%
  filter(CatchGroup == 'crustaceans') %>%
  group_by(CLvesselFlagCountry, AreaMap) %>%
  summarise(CLscientificWeight_ton = sum(CLscientificWeight_ton)) %>%
...
#### Metier lvl5
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap = '**Figure 89**:  Crustacean species landings by metier level 5 (top 20).'}
#data prep
sub_cl_top <- cl%>%
  filter(CatchGroup == 'crustaceans')%>%
  mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl5 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap = '**Figure 90**:  Proportion of countries landings of crustacean species by metier level 5 (top 20).'}
#data prep
sub_cl_2 <- cl%>%
  filter(CatchGroup == 'crustaceans') %>%
    mutate(CLmetier5 = substr(CLmetier6, 1, 7))%>%
...
#### Metier lvl6
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 91**:  Crustacean species landings by metier level 6 (top 20).'}
sub_cl_top <- cl%>%
  filter(CatchGroup == 'crustaceans')%>%
  group_by(CLyear, CLmetier6) %>%
  summarise(CLscientificWeight_1000ton = sum(CLscientificWeight_1000ton)) %>%
...
#### Metier lvl6 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 92**:  Proportion of countries landings of crustacean species by metier level 6 (top 20).'}
...
#### Harbour
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 93**:  Crustacean species landings in the main harbours (top 20).'}
...
#### Harbour and flag country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap = '**Figure 94**:  Proportion of crustacean species landings by flag country and harbour.'}
sub_cl_2<- cl%>%
  filter(CatchGroup == 'crustaceans')%>%
  group_by(CLyear, CLlandingLocation, CLvesselFlagCountry) %>%
  summarise(CLscientificWeight_1000ton_total = sum(CLscientificWeight_1000ton))
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 95**: Map with the landing weight of crustacean species by main harbours (top 20).'}
...
```{r riverplot aboard crustaceans, echo = FALSE, warning = FALSE, message = FALSE,results = "asis", dpi=100, fig.width=9,fig.height=9, fig.cap = '**Figure 96**: River plot of crustacean species landings between vessel Flag Country (left), Harbour Country (center) and landing Country (right). Width of each line is proportional to landings proportion. Harbour Country is the country code obtained from the CLlandingLocation.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 97**: Spatial distribution of the crustaceans landings by statistical rectangle.'}
# do we need information on for how many rows(%) there was a missing CLscientificWeight_ton? <-------------------------- to do
...
### number of trips
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 98**: Total number of trips performed by country.'}
...
### days at sea
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 99**: Total number of days at sea performed by country.'}
...
### KW-days
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 100**: Total number of KW-days performed by country.'}
...
### GT-days
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 101**: Total number of GT-days performed by country.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 102**: Total number of trips performed by vessel country fleet segment.'}
sub_ce_top<- ce%>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 103**: Distribution of the number of trips performed by countries in each vessel fleet segment of size category.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 104**: Distribution of the number of trips performed by vessel fleet segment of size category, for each country.'}
...
#### Area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 105**: Number of trips performed by vessels with LOA below 10m, by area.'}
...
#### Area and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 106**: Distribution of the number of trips performed by country vessels with LOA below 10m, in each area.'}
...
#### Country and area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 107**: Distribution of trips performed by vessels with LOA below 10m in each area, by country.'}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 108**: Number of trips performed by vessels with LOA of 10m and above, by area.'}
...
#### Area and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 109**: Distribution of the number of trips performed by country vessels with LOA of 10m and above, in each area.'}
...
#### Country and area
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 110**: Distribution of trips performed by vessels with LOA of 10m and above in each area, by country.'}
...
### Below 10 meters  {.tabset}
#### Metier lvl5
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 111**: Number of trips performed by vessels with LOA below 10m, by metier level5.'}
#data prep
sub_ce_top <- ce%>%
...
#### Metier lvl5 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 112**: Distribution of the number of trips performed by country vessels with LOA below 10m, with metier level 5.'}
#data prep
sub_ce_2 <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL0006", "VL0608", "VL0810"))%>%
    mutate(CEmetier5 = substr(CEmetier6, 1, 7))%>%
...
barplot(data = sub_ce_2_top, 
      x = "CEmetier5",
      y = "CEnumberOfDominantTrips_total",
      group = "CEvesselFlagCountry",
      ylab = "Number of trips (%)",
      asPct = T)
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 113**: Distribution of trips performed by vessels with LOA below 10m with metier level 5, by country.'}
#data prep
sub_ce_2 <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL0006", "VL0608", "VL0810"))%>%
    mutate(CEmetier5 = substr(CEmetier6, 1, 7))%>%
...
### 10 meters and above  {.tabset}
#### Metier lvl5
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 114**: Number of trips performed by vessels with LOA of 10m and above, by metier level5.'}
#data prep
sub_ce_top <- ce%>%
...
#### Metier lvl5 and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 115**: Distribution of the number of trips performed by country vessels with LOA of 10m and above, with metier level 5.'}
#data prep
sub_ce_2 <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL1012", "VL1215", "VL1518","VL1824","VL2440","VL40XX"))%>%
    mutate(CEmetier5 = substr(CEmetier6, 1, 7))%>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 116**: Distribution of trips performed by vessels with LOA of 10m and above with metier level 5, by country.'}
#data prep
sub_ce_2 <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL1012", "VL1215", "VL1518","VL1824","VL2440","VL40XX"))%>%
    mutate(CEmetier5 = substr(CEmetier6, 1, 7))%>%
...
### Below 10 meters {.tabset}
#### Harbour
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7,fig.height=7, fig.cap='**Figure 117**: Number of trips performed by vessels with LOA below 10m, from the main harbours (top 20).'}
#data prep
sub_ce_top <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL0006", "VL0608", "VL0810"))%>%
...
#### Harbour and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 118**: Distribution of the number of trips performed by country vessels with LOA below 10m, from the main harbours (top 20).'}
#data prep
sub_ce_2 <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL0006", "VL0608", "VL0810"))%>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 119**: Distribution of the number of trips performed by country vessels with LOA below 10m, from the main harbours (top 20).'}
sub_ce_top %>%  mutate(
         analysis_type = 'sum',
         type_of_threshold = 'none',
         value_of_threshold = NA
...
#### Harbour
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 120**: Number of trips performed by vessels with LOA of 10m and above, from the main harbours (top 20).'}
#data prep
sub_ce_top <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL1012", "VL1215", "VL1518","VL1824","VL2440","VL40XX"))%>%
  group_by(CEyear, CElandingLocation) %>%
...
#### Harbour and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=7,fig.height=7, fig.cap='**Figure 121**: Distribution of the number of trips performed by country vessels with LOA of 10m and above, from the main harbours (top 20).'}
#data prep
sub_ce_2 <- ce%>%
  filter(CEvesselLengthCategory %in% c("VL1012", "VL1215", "VL1518","VL1824","VL2440","VL40XX"))%>%
  group_by(CEyear, CElandingLocation, CEvesselFlagCountry) %>%
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 122**: Distribution of the number of trips performed by country vessels with LOA 10m and above, from the main harbours (top 20).'}
sub_ce_top %>%  mutate(
         analysis_type = 'sum',
         type_of_threshold = 'none',
         value_of_threshold = NA
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 123**: Spatial distribution of the fishing effort (dominant trips) performed by vessels with LOA below 10m, by statistical rectangle.'}
# data prep
ce %>%
  filter(CEvesselLengthCategory %in% c("VL0006", "VL0608", "VL0810")) %>% 
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure 124**: Spatial distribution of the fishing effort (dominant trips) performed by vessels with LOA of 10m and above, by statistical rectangle.'}
# data prep
ce %>%
  filter(CEvesselLengthCategory %in% c("VL1012", "VL1215", "VL1518","VL1824","VL2440","VL40XX")) %>% 
  group_by(CEyear, CEstatisticalRectangle) %>%
...
The data referring to the present year was collected under the RCG 2026 data call for the 2025 data for the Baltic Sea, North Sea, Eastern Arctic and the North Atlantic regions and the latest version used was downloaded from the system on the 14th of May 2026 with the exception of information detailed in section “2. Overall Fleet Evolution” which was extracted from the EU Fleet Register (https://webgate.ec.europa.eu/fleet-europa/index_en) on the March 2026.
