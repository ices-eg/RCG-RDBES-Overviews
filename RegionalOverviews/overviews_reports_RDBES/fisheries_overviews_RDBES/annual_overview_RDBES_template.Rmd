...
#### species
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure**: Landings (1000 t) in the 20 main Species.'}
...
#### species and country
```{r, echo = FALSE, warning = FALSE, message = FALSE, results = "asis", dpi=100, fig.width=6,fig.height=6, fig.cap='**Figure**: Landings (1000 t) by 20 main Species and Country.'}
...
```{r riverplot aborad sp, echo = FALSE, warning = FALSE, message = FALSE,results = "asis", dpi=100, fig.width=9,fig.height=9, fig.cap = '**Figure**:River plot of Landings (1000t) of small pelagic between vessel Flag Country (left), Harbour Country (center) and landing Country(right). Width of line is proportional to landings. Harbour Country is the Country from the CLlandingLocation.'}
...
Plot below shows the Landing (1000t) of demersal between CLvesselFlagCountry (left), Harbour Country * (center) and CLlandingCountry(right).
```{r riverplot aborad demersal, echo = FALSE, warning = FALSE, message = FALSE,results = "asis", dpi=100, fig.width=9,fig.height=9, fig.cap = '**Figure**:River plot of Landings (1000t) of demersal between vessel Flag Country (left), Harbour Country (center) and landing Country(right). Width of line is proportional to landings. Harbour Country is the Country from the CLlandingLocation.'}
...
Plot below shows the Landing (1000t) of flatfish between CLvesselFlagCountry (left), Harbour Country * (center) and CLlandingCountry(right).

```{r riverplot aborad flatfish, echo = FALSE, warning = FALSE, message = FALSE,results = "asis", dpi=100, fig.width=9,fig.height=9, fig.cap = '**Figure**:River plot of Landings (1000t) of flatfish between vessel Flag Country (left), Harbour Country (center) and landing Country (right). Width of line is proportional to landings. Harbour Country is the Country from the CLlandingLocation.'}
