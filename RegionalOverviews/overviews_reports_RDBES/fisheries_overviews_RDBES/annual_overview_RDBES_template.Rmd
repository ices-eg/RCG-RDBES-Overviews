...
barplot(data = cl_catch, 
      x = "RCM_NSEA_categ",
      y = "CLscientificWeight_1000ton",
      titel = "Landings (1000 t) by Catch Group",
      ylab = "Proportion of Landings (1000 t)")
```
...
barplot(data = cl_catch, 
      ...
      y = "CLscientificWeight_1000ton",
      group = "CLlandingCountry",
      titel = "Landings (1000 t) by Catch Group and Country",
      ylab = "Proportion of Landings (1000 t)",
      asPct = T)
...
barplot(data = cl_metier_lvl6, 
      x = "CLmetier6",
      y = "CLscientificWeight_1000ton",
      titel = "Landings (1000 t) by Metier Lvl6",
      ylab = "Sum of Landings (1000 t)")
```
...
barplot(data = cl_metier_lvl6_c_top, 
        ...
        titel = "Landings (1000 t) by Metier Lvl6 and Country",
        group = "CLlandingCountry",
        ylab = "Proportion of Landings (1000 t)",
        asPct = T)
```
