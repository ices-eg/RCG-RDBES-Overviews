...
# Make your selection 
yearsSelected = c(2021, 2022, 2023, 2024, 2025)
year = 2025
regionSelected = 'LDF'  
...
dataprepDate = 20260708 # Date on which data where prepared. If prepared data are downloaded from ICES SP, then this is the date used for the data folder name on the ICES SP. 
